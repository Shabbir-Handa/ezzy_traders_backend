...
from app.models import (
    Customer, Quotation, QuotationItem, QuotationItemAttribute,
    DoorTypeThicknessOption, Attribute, AttributeOption, UnitValue,
    QuotationItemNestedAttribute, CostType
)
...
class CustomerQuotationRepository:
    ...
    @staticmethod
    def get_quotation_item_nested_attributes_by_item(db: Session, quotation_item_id: int) -> List[QuotationItemNestedAttribute]:
        return db.query(QuotationItemNestedAttribute).options(
            joinedload(QuotationItemNestedAttribute.nested_attribute)
        ).filter(
    ...
    @staticmethod
    def update_quotation_item_nested_attribute(db: Session, nested_attribute_id: int, data: dict, updated_by: str = None) -> Optional[QuotationItemNestedAttribute]:
